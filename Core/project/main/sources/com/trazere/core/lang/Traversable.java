...
// TODO: PairTraversable

/**
 * The {@link Traversable} interface defines generic containers of elements that can be traversed.
 * 
 * @param <E> Type of the elements.
 * @param <T> Type of the traversable (self type).
 * @since 2.0
 */
public interface Traversable<E, T extends Traversable<E, T>> {
	 ...
	 * @since 2.0
	 */
	<S> S fold(final Function2<? super S, ? super E, ? extends S> operator, final S initialState);
	 ...
	 * @since 2.0
	 */
	boolean isAny(final Predicate<? super E> filter);
	 ...
	 * @since 2.0
	 */
	boolean areAll(final Predicate<? super E> filter);
	 ...
	 * @since 2.0
	 */
	int count(final Predicate<? super E> filter);
	 ...
	 * @since 2.0
	 */
	Maybe<E> least(final Comparator<? super E> comparator);
	 ...
	 * @since 2.0
	 */
	Maybe<E> greatest(final Comparator<? super E> comparator);
	 ...
	 * @since 2.0
	 */
	<B extends Collection<? super E>> Traversable<B, ?> group(final int n, final CollectionFactory<? super E, B> batchFactory);
	 ...
	 * @since 2.0
	 */
	T filter(final Predicate<? super E> filter);
	 ...
	 * @since 2.0
	 */
	Maybe<E> filterFirst(final Predicate<? super E> filter);
	 ...
	 * @since 2.0
	 */
	<TE> Traversable<TE, ?> map(final Function<? super E, ? extends TE> function);
	 ...
	 * @since 2.0
	 */
	<EE> Traversable<EE, ?> extract(final Function<? super E, ? extends Maybe<? extends EE>> extractor);
	 ...
	 * @since 2.0
	 */
	<EE> Maybe<EE> extractFirst(final Function<? super E, ? extends Maybe<? extends EE>> extractor);
	...
	//	 * @since 2.0
	//	 */
	//	<EE> Traversable<EE, ?> extractAll(final Function<? super E, ? extends Iterable<? extends EE>> extractor);
	...
	//	 * @since 2.0
	//	 */
	//	<TE> Traversable<TE, ?> flatMap(final Function<? super E, ? extends Traversable<? extends TE, ?>> extractor);
	 ...
	 * @since 2.0
	 */
	void foreach(final Procedure<? super E> procedure);
}
