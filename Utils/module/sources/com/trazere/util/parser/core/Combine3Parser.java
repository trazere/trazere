...
extends AbstractParser<Token, Result> {
	...
	protected final Parser<Token, SubResult3> _subParser3;
	
	public Combine3Parser(final Parser<Token, SubResult1> subParser1, final Parser<Token, SubResult2> subParser2, final Parser<Token, SubResult3> subParser3, final String description) {
		super(description);
